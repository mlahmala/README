...
![Diagram1](https://user-images.githubusercontent.com/77897480/139863601-3e93b79b-0bd2-4a4d-a674-bf0679230d3f.PNG)
...
|----------|----------|------------|------------------|
| Jump Box | Gateway  | 10.0.2.4   | Linux (Ubuntu)            |
| Web 1   | Server         | 10.0.2.7           | Linux (Ubuntu)              |
| Web 2   | Server         | 10.0.0.8          | Linux (Ubuntu)               |
| ELK Server | Log Server   | 10.0.2.6          | Linux (Ubuntu)  |
